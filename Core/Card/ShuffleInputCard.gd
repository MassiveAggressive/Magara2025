class_name ShuffleInputCard extends CardBase
...
func ApplyEffect() -> void:
	...
	player_1_input_keys[Util.EInputKey.MOVERIGHT] = player_state.player_2_input_keys[Util.EInputKey.MOVERIGHT]
	player_1_input_keys[Util.EInputKey.MOVELEFT] = player_state.player_2_input_keys[Util.EInputKey.MOVELEFT]
	player_1_input_keys[Util.EInputKey.JUMP] = player_state.player_2_input_keys[Util.EInputKey.JUMP]
	player_1_input_keys[Util.EInputKey.DASH] = player_state.player_1_input_keys[Util.EInputKey.DASH]
	
	player_2_input_keys[Util.EInputKey.MOVERIGHT] = player_state.player_1_input_keys[Util.EInputKey.MOVERIGHT]
	player_2_input_keys[Util.EInputKey.MOVELEFT] = player_state.player_1_input_keys[Util.EInputKey.MOVELEFT]
	player_2_input_keys[Util.EInputKey.JUMP] = player_state.player_1_input_keys[Util.EInputKey.JUMP]
